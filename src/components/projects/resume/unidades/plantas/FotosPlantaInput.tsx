...
export function FotosPlantaInput({ allowedTypes, accept, projectData, setLoadingFiles, unidadeInView }: FotosInputProps
) {
        ...
        const uploadFotos = async (updateData: Investment, selectedFiles: FileList) => {
            ...
            try {
                ...
                for (let index = 0; index < imageUrls.length; index++) {
                    updateData.apartamentTypes[unidadeInView].plantas.push(imageUrls[index])
                }
