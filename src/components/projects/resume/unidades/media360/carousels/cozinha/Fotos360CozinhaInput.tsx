...
export function Fotos360CozinhaInput({ allowedTypes, accept, projectData, setLoadingFiles, unidadeInView }: FotosInputProps
) {
        ...
        const uploadFotos = async (updateData: Investment, selectedFiles: FileList) => {
            ...
            try {
                ...
                for (let index = 0; index < imageUrls.length; index++) {
                    updateData.apartamentTypes[unidadeInView].media360.cozinha.push(imageUrls[index])
                }
