...
import { Fotos360Input } from "./Fotos360Input";
...
export function Fotos360({ userData, projectData, openImage, setLoadingFiles, unidadeInView, setFotoType }: FotosGeraisProps) {
