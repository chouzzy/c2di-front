...
export function MyInvestmentCards({ userInvestmentsData, projectsData }: MyInvestmentCardsProps) {
    ...
    const bgSlideColor = useColorModeValue('darkSide', 'dark.lightSide')
            ...
            {isMobile ?
                ...
                <Container gap={4} maxW={'90vw'} color={'lightSide'} alignItems={'center'} justifyContent={'center'}>
                    ...
                    >
                        <SwiperSlide key={'1'}>
                            {/* CARD 1 */}
                            <Flex minH={40} flexDir={'column'} gap={4} w='100%' bgColor={bgSlideColor} px={8} py={4} borderRadius={12}>
                ...
                <Flex gap={4} w='100%' color={'lightSide'}>
                    ...
                    {/* CARD 1 */}
                    <Flex flexDir={'column'} gap={4} w='100%' bgColor={bgSlideColor} px={8} py={4} borderRadius={12}>
