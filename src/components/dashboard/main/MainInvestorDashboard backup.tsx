                    ...
                    <Flex justifyContent={'space-between'} alignItems={['center', 'center', 'center', 'center', 'start']} w='100%' flexDir={['column', 'column', 'column', 'row', 'row']} mt={8}>
                        ...
                        <Flex flexDir={'column'} gap={2}>
                            ...
                            <Flex>
                                ...
                                <BarChart width={600} height={420} data={data} barGap={20} layout="vertical"> {/* Alteração aqui! Adicionado layout vertical */}
                                    <YAxis type="category" dataKey="etapa" /> {/* YAxis agora é categórico e usa 'etapa' */}
                                    <XAxis type="number" hide />  {/* XAxis agora é numérico e está oculto */}
                                    <Tooltip />
                                    <Legend />
                                    <Bar radius={2} barSize={64} dataKey="pv" fill="#64748B" /> {/* Mantém dataKey, pois agora representa o valor na horizontal */}
                                    <Bar radius={2} barSize={64} dataKey="uv" fill="#46cb18" /> {/* Mantém dataKey, pois agora representa o valor na horizontal */}
                                </BarChart>
                            </Flex>
                        </Flex>
