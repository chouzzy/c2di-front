...
const getUserInvestmentListComplete = async () => {
    try {
        ...
        const response = await axios.get(`https://c2di-front.vercel.app/usersInvestments/`, { 
...
const filterUserInvestmentsByInvestmentID = async ({page, pageRange, investmentID}:getUserInvestmentListByInvestmentIDProps) => {
    try {
        ...
        const response = await axios.get(`https://c2di-front.vercel.app/usersInvestments/byInvestment`, { 
            params: {
                investmentID: investmentID,
                page: page,
                pageRange: pageRange,
